...
<small><em>
This manuscript
([permalink](https://lubianat.github.io/ann_sprint/v/63c47a7ac6ecc1597dc90c33b34c57c657b0e824/))
was automatically generated
from [lubianat/ann_sprint@63c47a7](https://github.com/lubianat/ann_sprint/tree/63c47a7ac6ecc1597dc90c33b34c57c657b0e824)
on November 18, 2020.
</em></small>
...
+ **Sabine Weber**<br>
    ...
    · ![GitHub icon](images/github.svg){.inline_icon}
    [webersab](https://github.com/webersab)
    · ![Twitter icon](images/twitter.svg){.inline_icon}
    [multilingual_s](https://twitter.com/multilingual_s)<br>
  <small>
...
+ **Bruno Andrade Paranhos**<br>
    ...
    · ![GitHub icon](images/github.svg){.inline_icon}
    [paranhosba](https://github.com/paranhosba)
    · ![Twitter icon](images/twitter.svg){.inline_icon}
    [labdrafts](https://twitter.com/labdrafts)<br>
  <small>
...
+ **Dayane Araújo**<br>
    ...
    · ![GitHub icon](images/github.svg){.inline_icon}
    [DayaneRAraujo](https://github.com/DayaneRAraujo)
    · ![Twitter icon](images/twitter.svg){.inline_icon}
    [Dada_bio](https://twitter.com/Dada_bio)<br>
  <small>
...
+ **Ana Dorrego-Rivas**<br>
    ...
    · ![GitHub icon](images/github.svg){.inline_icon}
    [anadorrego](https://github.com/anadorrego)
    · ![Twitter icon](images/twitter.svg){.inline_icon}
    [adorrego_r](https://twitter.com/adorrego_r)<br>
  <small>
...
+ **Delwen Franzen**<br>
    ...
    · ![GitHub icon](images/github.svg){.inline_icon}
    [delwen](https://github.com/delwen)
    · ![Twitter icon](images/twitter.svg){.inline_icon}
    [DelwenFranzen](https://twitter.com/DelwenFranzen)<br>
  <small>
...
+ **Gabriela Nogueira Viçosa**<br>
    ...
    · ![GitHub icon](images/github.svg){.inline_icon}
    [gabrielanvicosa](https://github.com/gabrielanvicosa)
    · ![Twitter icon](images/twitter.svg){.inline_icon}
    [Vix_Gabi](https://twitter.com/Vix_Gabi)<br>
  <small>
     None
  </small>
...
+ **Arup Ghosh**<br>
    ...
    · ![GitHub icon](images/github.svg){.inline_icon}
    [arupgsh](https://github.com/arupgsh)
    · ![Twitter icon](images/twitter.svg){.inline_icon}
    [arupgsh](https://twitter.com/arupgsh)<br>
  <small>
...
+ **Inés Hojas García-Plaza**<br>
    ![ORCID icon](images/orcid.svg){.inline_icon}
    [0000-0002-8930-8268](https://orcid.org/0000-0002-8930-8268)
    · ![GitHub icon](images/github.svg){.inline_icon}
    [ineshojas](https://github.com/ineshojas)
    · ![Twitter icon](images/twitter.svg){.inline_icon}
    [ines_hojas](https://twitter.com/ines_hojas)<br>
  <small>
